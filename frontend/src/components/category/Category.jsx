...
function Category() {
    ...
    return (
        <div className='mt-14 mb-12 '>
            <div className='container hero-bg-color rounded-3xl'>
                {/* Header Section */}
                <div className='text-center mb-10 max-w-[600px] mx-auto'>
                    <p className='text-sm text-primary'>Top Selling Products</p>
                    <h1 className='text-3xl font-bold'>Products</h1>
                    <p className='text-xs text-gray-400'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi molestiae deserunt
